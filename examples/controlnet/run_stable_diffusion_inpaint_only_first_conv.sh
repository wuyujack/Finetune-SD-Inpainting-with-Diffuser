...
export OUTPUT_DIR="./save_stable_diffusion_inpaint_only_first_conv/no_text_lr_1e-5_1epoch_debug/"

accelerate launch train_stablediffusion_inpaint_with_cloth_channel_only_retrain_first_conv.py \
