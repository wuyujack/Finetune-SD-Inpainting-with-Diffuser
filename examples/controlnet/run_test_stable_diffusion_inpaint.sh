...
export OUTPUT_DIR="./save_stable_diffusion_inpaint/no_text_lr_1e-5_1epoch_debug/"
export VAL_DIR="./save_stable_diffusion_inpaint/no_text_lr_1e-5_1epoch_debug/"

accelerate launch test_stablediffusion_inpaint_with_cloth_channel.py \
 --pretrained_model_name_or_path=$MODEL_DIR \
 --output_dir=$OUTPUT_DIR \
 --val_model_dir=$VAL_DIR \
