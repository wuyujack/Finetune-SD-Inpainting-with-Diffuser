...
export OUTPUT_DIR="./save_stable_diffusion_inpaint/no_text_lr_1e-5_1epoch_debug_validation/"

accelerate launch train_stablediffusion_inpaint_with_cloth_channel.py \
